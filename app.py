...
# - Enter 'a' to add a movie, 'I' to see movies, 'f' to find a movie, and 'q' to quit:
...
# [x]: Show the users the main interface and get their input
...
def menu():
    ...
    while user_input != 'q':
        ...
        user_input = input("\nEnter 'a' to add a movie, 'l' to see movies, 'f' to find a movie, and 'q' to quit: ")
